...
fs.readdir('lib', (err, files) => {
  ...
  // Filter out onCalendarCleanup.js file
  files = files.filter(file => file !== 'onCalendarCleanup.js')
  ...
  const link = 'https://github.com/scriptPilot/google-calendar-cleanup'
  codeBlocks.push(`// Google Calendar Cleanup, build on ${date}\n// Source: ${link}`)
